...
function Timeliner(target) {
	...
	dispatcher.on('keyframe', function(layer, value) {
		...
		if (typeof(v) === 'number') {
			layer.values.splice(v, 0, {
				time: t,
				value: value,
				tween: 'linear',			// doojin : set default linear
	...
	*/
	...
	// Shadow Root
        ...
        var root = document.getElementById('timeline-container');
        document.getElementById('timeline-container');
        var siteContainer = document.getElementById('site-container');            
	siteContainer.appendChild(root);
	...
	(function DockingWindow() {
	    ...
	    // setBounds(pane, 100, 0, Settings.width, Settings.height);
	    // setBounds(ghostpane, 0, 0, Settings.width, Settings.height);	    
	    setBounds(pane, 0, window.innerHeight-Settings.height, window.innerWidth, Settings.height);
	    setBounds(ghostpane, 0, window.innerHeight-Settings.height, window.innerWidth, Settings.height);
