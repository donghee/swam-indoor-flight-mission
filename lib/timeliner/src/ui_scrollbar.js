...
var scrolltrack_style = {
	...
	// top: '0',
	// bottom: '0',
	background: '-webkit-gradient(linear, left top, right top, color-stop(0, rgba(51,51,51,0.2)), color-stop(0.6, rgba(70,70,70,0.2)) )',
...
var scrollbar_style = {
	background: '-webkit-gradient(linear, left top, right top, color-stop(0.2, rgba(88,88,88,0.2)), color-stop(0.6, rgba(64,64,64,0.2)) )',
	border: '1px solid rgba(51,51,51,0.2)',
	// position: 'absolute',
	position: 'relative',
	borderRadius: '6px'
